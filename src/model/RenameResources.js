...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.RenameResources = factory(root.ExaVaultApi.ApiClient);
  }
  ...
  /**
   * The RenameResources model module.
   * @module model/RenameResources
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>RenameResources</code>.
   * @alias module:model/RenameResources
   * @class
   * @param accessToken {String} Access token required to make the API call.
   * @param filePath {String} Remote path of the file or folder to rename.
   * @param newName {String} The new name of the file or folder.
   */
  var exports = function(accessToken, filePath, newName) {
    var _this = this;
  ...
  /**
   * Constructs a <code>RenameResources</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RenameResources} obj Optional instance to populate.
   * @return {module:model/RenameResources} The populated <code>RenameResources</code> instance.
   */
