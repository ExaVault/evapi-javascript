...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.UpdateUser = factory(root.ExaVaultApi.ApiClient);
  }
   ...
   * @param userId {Number} The user's ID. Note that this is our internal ID, and _not the username_. You can obtain it by calling the <a href=\"#operation/getUser\">getUser</a> method.
   */
  var exports = function(accessToken, userId) {
    var _this = this;
   ...
   * @member {module:model/UpdateUser.RoleEnum} role
   */
   ...
   * @member {module:model/UpdateUser.PermissionsEnum} permissions
   */
