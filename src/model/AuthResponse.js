...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./Auth'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.AuthResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.Auth);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = Auth.constructFromObject(data['results']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/AuthResponse.SuccessEnum} success
   */
  ...
  /**
   * @member {module:model/Auth} results
   */
