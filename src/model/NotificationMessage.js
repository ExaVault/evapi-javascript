...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.NotificationMessage = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.Notification);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('notificationSetting')) {
        obj['notificationSetting'] = Notification.constructFromObject(data['notificationSetting']);
      }
   ...
   * @member {module:model/Notification} notificationSetting
   */
  exports.prototype['notificationSetting'] = undefined;
  /**
   * Message body.
   ...
   * @member {module:model/NotificationMessage.ActionEnum} action
   */
