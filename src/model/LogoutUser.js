...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.LogoutUser = factory(root.ExaVaultApi.ApiClient);
  }
  ...
  /**
   * The LogoutUser model module.
   * @module model/LogoutUser
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>LogoutUser</code>.
   * @alias module:model/LogoutUser
   * @class
  ...
  /**
   * Constructs a <code>LogoutUser</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LogoutUser} obj Optional instance to populate.
   * @return {module:model/LogoutUser} The populated <code>LogoutUser</code> instance.
   */
