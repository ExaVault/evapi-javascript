...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/NotificationMessage'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./NotificationMessage'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.NotificationActivityResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.NotificationMessage);
  }
}(this, function(ApiClient, NotificationMessage) {
  'use strict';
  ...
  /**
   * The NotificationActivityResponse model module.
   * @module model/NotificationActivityResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>NotificationActivityResponse</code>.
   * @alias module:model/NotificationActivityResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>NotificationActivityResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NotificationActivityResponse} obj Optional instance to populate.
   * @return {module:model/NotificationActivityResponse} The populated <code>NotificationActivityResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [NotificationMessage]);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/NotificationActivityResponse.SuccessEnum} success
   */
   ...
   * @member {Array.<module:model/NotificationMessage>} results
   */
