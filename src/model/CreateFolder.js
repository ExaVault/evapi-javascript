...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.CreateFolder = factory(root.ExaVaultApi.ApiClient);
  }
   ...
   * @module model/CreateFolder
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>CreateFolder</code>.
   * @alias module:model/CreateFolder
   * @class
   * @param accessToken {String} Access token required to make the API call.
   * @param folderName {String} Name of the folder to create.
   * @param path {String} Where to create the folder. Use **_/_** to create a folder in the user's home directory.
   */
  var exports = function(accessToken, folderName, path) {
    var _this = this;
   ...
   * @param {module:model/CreateFolder} obj Optional instance to populate.
   * @return {module:model/CreateFolder} The populated <code>CreateFolder</code> instance.
   */
