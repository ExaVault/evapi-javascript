...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModifiedResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ModifiedResource'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.ModifiedResourcesResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.ModifiedResource);
  }
}(this, function(ApiClient, ModifiedResource) {
  'use strict';
  ...
  /**
   * The ModifiedResourcesResponse model module.
   * @module model/ModifiedResourcesResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>ModifiedResourcesResponse</code>.
   * @alias module:model/ModifiedResourcesResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ModifiedResourcesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModifiedResourcesResponse} obj Optional instance to populate.
   * @return {module:model/ModifiedResourcesResponse} The populated <code>ModifiedResourcesResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [ModifiedResource]);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/ModifiedResourcesResponse.SuccessEnum} success
   */
  ...
  /**
   * 
   * @member {Array.<module:model/ModifiedResource>} results
   */
