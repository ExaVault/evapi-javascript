...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.ResourceResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.Resource);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = Resource.constructFromObject(data['results']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/ResourceResponse.SuccessEnum} success
   */
  ...
  /**
   * Array of Resources.
   * @member {module:model/Resource} results
   */
