...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.CopyResources = factory(root.ExaVaultApi.ApiClient);
  }
  ...
  /**
   * The CopyResources model module.
   * @module model/CopyResources
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>CopyResources</code>.
   * @alias module:model/CopyResources
   * @class
   * @param accessToken {String} Access token required to make the API call.
   * @param filePaths {Array.<String>} Array containing file/folder paths to copy.
   * @param destinationPath {String} Remote destination path to copy files/folders to.
   */
  ...
  /**
   * Constructs a <code>CopyResources</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CopyResources} obj Optional instance to populate.
   * @return {module:model/CopyResources} The populated <code>CopyResources</code> instance.
   */
