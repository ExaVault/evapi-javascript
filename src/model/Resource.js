...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DirectFile', 'model/Notification', 'model/ResourceProperty', 'model/Share'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DirectFile'), require('./Notification'), require('./ResourceProperty'), require('./Share'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.Resource = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.DirectFile, root.ExaVaultApi.Notification, root.ExaVaultApi.ResourceProperty, root.ExaVaultApi.Share);
  }
}(this, function(ApiClient, DirectFile, Notification, ResourceProperty, Share) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('resources')) {
        obj['resources'] = ApiClient.convertToType(data['resources'], [ResourceProperty]);
      }
      if (data.hasOwnProperty('inheritedShares')) {
        obj['inheritedShares'] = ApiClient.convertToType(data['inheritedShares'], [Share]);
      }
      if (data.hasOwnProperty('inheritedNotifications')) {
        obj['inheritedNotifications'] = ApiClient.convertToType(data['inheritedNotifications'], [Notification]);
      }
      if (data.hasOwnProperty('inheritedDirectFiles')) {
        obj['inheritedDirectFiles'] = ApiClient.convertToType(data['inheritedDirectFiles'], [DirectFile]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/ResourceProperty>} resources
   */
  exports.prototype['resources'] = undefined;
  /**
   * Array of all shares inside the given resource. Property not emtpy only if `detailed` param was set to `true`.
   * @member {Array.<module:model/Share>} inheritedShares
   */
  exports.prototype['inheritedShares'] = undefined;
  /**
   * Array of all notifications inside the given resource. Property not emtpy only if `detailed` param was set to `true`.
   * @member {Array.<module:model/Notification>} inheritedNotifications
   */
  exports.prototype['inheritedNotifications'] = undefined;
  /**
   * Array of all direct file objects inside the given resource. Property not emtpy only if `detailed` param was set to `true`.
   * @member {Array.<module:model/DirectFile>} inheritedDirectFiles
   */
  exports.prototype['inheritedDirectFiles'] = undefined;
