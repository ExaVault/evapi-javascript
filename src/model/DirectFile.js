...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.DirectFile = factory(root.ExaVaultApi.ApiClient);
  }
  ...
  /**
   * The DirectFile model module.
   * @module model/DirectFile
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>DirectFile</code>.
   * @alias module:model/DirectFile
   * @class
   */
  ...
  /**
   * Constructs a <code>DirectFile</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DirectFile} obj Optional instance to populate.
   * @return {module:model/DirectFile} The populated <code>DirectFile</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isIndexEnabled')) {
        obj['isIndexEnabled'] = ApiClient.convertToType(data['isIndexEnabled'], 'String');
      }
      if (data.hasOwnProperty('blockUntil')) {
        obj['blockUntil'] = ApiClient.convertToType(data['blockUntil'], 'String');
      }
   ...
   * @member {String} isIndexEnabled
   */
  exports.prototype['isIndexEnabled'] = undefined;
  /**
   ...
   * @member {String} blockUntil
   */
  exports.prototype['blockUntil'] = undefined;
  /**
