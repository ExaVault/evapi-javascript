...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResourceProperty'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResourceProperty'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.ResourcePropertiesResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.ResourceProperty);
  }
}(this, function(ApiClient, ResourceProperty) {
  'use strict';
  ...
  /**
   * The ResourcePropertiesResponse model module.
   * @module model/ResourcePropertiesResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>ResourcePropertiesResponse</code>.
   * @alias module:model/ResourcePropertiesResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ResourcePropertiesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResourcePropertiesResponse} obj Optional instance to populate.
   * @return {module:model/ResourcePropertiesResponse} The populated <code>ResourcePropertiesResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [ResourceProperty]);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/ResourcePropertiesResponse.SuccessEnum} success
   */
   ...
   * @member {Array.<module:model/ResourceProperty>} results
   */
