...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.SharesResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.Share);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [Share]);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/SharesResponse.SuccessEnum} success
   */
   ...
   * @member {Array.<module:model/Share>} results
   */
