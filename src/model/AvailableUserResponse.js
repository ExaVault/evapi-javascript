...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AvailableUser'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AvailableUser'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.AvailableUserResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.AvailableUser);
  }
}(this, function(ApiClient, AvailableUser) {
  'use strict';
  ...
  /**
   * The AvailableUserResponse model module.
   * @module model/AvailableUserResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>AvailableUserResponse</code>.
   * @alias module:model/AvailableUserResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AvailableUserResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AvailableUserResponse} obj Optional instance to populate.
   * @return {module:model/AvailableUserResponse} The populated <code>AvailableUserResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = AvailableUser.constructFromObject(data['results']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/AvailableUserResponse.SuccessEnum} success
   */
  ...
  /**
   * @member {module:model/AvailableUser} results
   */
