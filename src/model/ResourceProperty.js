...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Share'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Share'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.ResourceProperty = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.Share);
  }
}(this, function(ApiClient, Share) {
  'use strict';
  ...
  /**
   * The ResourceProperty model module.
   * @module model/ResourceProperty
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>ResourceProperty</code>.
   * All properties of the resource.
   * @alias module:model/ResourceProperty
   * @class
   */
  ...
  /**
   * Constructs a <code>ResourceProperty</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResourceProperty} obj Optional instance to populate.
   * @return {module:model/ResourceProperty} The populated <code>ResourceProperty</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('notificationSettings')) {
        obj['notificationSettings'] = ApiClient.convertToType(data['notificationSettings'], 'String');
      }
      ...
      if (data.hasOwnProperty('directFile')) {
        obj['directFile'] = ApiClient.convertToType(data['directFile'], 'String');
      }
   ...
   * @member {String} notificationSettings
   */
  exports.prototype['notificationSettings'] = undefined;
  /**
   * Resource size.
   * @member {Number} size
   */
   ...
   */
  exports.prototype['previewable'] = undefined;
  /**
   * Associated direct file objects.
   * @member {String} directFile
   */
  exports.prototype['directFile'] = undefined;
  /**
   * Type of the resource.
   * @member {module:model/ResourceProperty.TypeEnum} type
   */
