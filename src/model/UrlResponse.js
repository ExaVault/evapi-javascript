...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.UrlResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.Url);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = Url.constructFromObject(data['results']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/UrlResponse.SuccessEnum} success
   */
   ...
   * @member {module:model/Url} results
   */
