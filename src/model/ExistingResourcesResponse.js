...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ExistingResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ExistingResource'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.ExistingResourcesResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.ExistingResource);
  }
}(this, function(ApiClient, ExistingResource) {
  'use strict';
  ...
  /**
   * The ExistingResourcesResponse model module.
   * @module model/ExistingResourcesResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>ExistingResourcesResponse</code>.
   * @alias module:model/ExistingResourcesResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ExistingResourcesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExistingResourcesResponse} obj Optional instance to populate.
   * @return {module:model/ExistingResourcesResponse} The populated <code>ExistingResourcesResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [ExistingResource]);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/ExistingResourcesResponse.SuccessEnum} success
   */
  ...
  /**
   * Array of resources.
   * @member {Array.<module:model/ExistingResource>} results
   */
