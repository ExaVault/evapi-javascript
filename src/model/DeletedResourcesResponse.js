...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DeletedResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DeletedResource'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.DeletedResourcesResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.DeletedResource);
  }
}(this, function(ApiClient, DeletedResource) {
  'use strict';
  ...
  /**
   * The DeletedResourcesResponse model module.
   * @module model/DeletedResourcesResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>DeletedResourcesResponse</code>.
   * @alias module:model/DeletedResourcesResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DeletedResourcesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeletedResourcesResponse} obj Optional instance to populate.
   * @return {module:model/DeletedResourcesResponse} The populated <code>DeletedResourcesResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [DeletedResource]);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/DeletedResourcesResponse.SuccessEnum} success
   */
  ...
  /**
   * 
   * @member {Array.<module:model/DeletedResource>} results
   */
