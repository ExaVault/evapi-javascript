...
* @version 2.2.3
*/
var UserCollectionResponse = function () {
    /**
    ...
    */
    ...
    function UserCollectionResponse() {
        _classCallCheck(this, UserCollectionResponse);
    ...
    */
    ...
    _createClass(UserCollectionResponse, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('data')) {
                    obj['data'] = _ApiClient2.default.convertToType(data['data'], [_User2.default]);
                }
...
exports.default = UserCollectionResponse;