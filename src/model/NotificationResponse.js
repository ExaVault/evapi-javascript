...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.NotificationResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.Notification);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = Notification.constructFromObject(data['results']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/NotificationResponse.SuccessEnum} success
   */
  ...
  /**
   * @member {module:model/Notification} results
   */
