...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/NotificationRecipient'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./NotificationRecipient'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.Notification = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.NotificationRecipient);
  }
}(this, function(ApiClient, NotificationRecipient) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('sendEmail')) {
        obj['sendEmail'] = ApiClient.convertToType(data['sendEmail'], 'String');
      }
   ...
   * @member {module:model/Notification.ActionEnum} action
   */
   ...
   * @member {module:model/Notification.SendEmailEnum} sendEmail
   */
  ...
  /**
   * Allowed values for the <code>sendEmail</code> property.
   * @enum {String}
   * @readonly
   */
  exports.SendEmailEnum = {
    /**
     * value: "0"
     * @const
     */
