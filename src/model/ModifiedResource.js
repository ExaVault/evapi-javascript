...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.ModifiedResource = factory(root.ExaVaultApi.ApiClient);
  }
  ...
  /**
   * The ModifiedResource model module.
   * @module model/ModifiedResource
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>ModifiedResource</code>.
   * Array of copied or moved resources.
   * @alias module:model/ModifiedResource
   * @class
   */
  ...
  /**
   * Constructs a <code>ModifiedResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModifiedResource} obj Optional instance to populate.
   * @return {module:model/ModifiedResource} The populated <code>ModifiedResource</code> instance.
   */
   ...
   * @member {module:model/ModifiedResource.SuccessEnum} success
   */
