...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.UserResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.User);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = User.constructFromObject(data['results']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/UserResponse.SuccessEnum} success
   */
  ...
  /**
   * @member {module:model/User} results
   */
