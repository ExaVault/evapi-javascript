...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.ShareLogEntry = factory(root.ExaVaultApi.ApiClient);
  }
  ...
  /**
   * The ShareLogEntry model module.
   * @module model/ShareLogEntry
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>ShareLogEntry</code>.
   * @alias module:model/ShareLogEntry
   * @class
   */
  ...
  /**
   * Constructs a <code>ShareLogEntry</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ShareLogEntry} obj Optional instance to populate.
   * @return {module:model/ShareLogEntry} The populated <code>ShareLogEntry</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('actionObjectId')) {
        obj['actionObjectId'] = ApiClient.convertToType(data['actionObjectId'], 'String');
      }
   ...
   * @member {String} actionObjectId
   */
  exports.prototype['actionObjectId'] = undefined;
  /**
