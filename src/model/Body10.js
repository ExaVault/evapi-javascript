    ...
    _createClass(Body10, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('archive Name')) {
                    obj['archive Name'] = _ApiClient2.default.convertToType(data['archive Name'], 'String');
                }
            }
            return obj;
        }
