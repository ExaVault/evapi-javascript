...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.AvailableUser = factory(root.ExaVaultApi.ApiClient);
  }
  ...
  /**
   * The AvailableUser model module.
   * @module model/AvailableUser
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>AvailableUser</code>.
   * Object contains infromation about username availability.
   * @alias module:model/AvailableUser
   * @class
   */
  ...
  /**
   * Constructs a <code>AvailableUser</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AvailableUser} obj Optional instance to populate.
   * @return {module:model/AvailableUser} The populated <code>AvailableUser</code> instance.
   */
