...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ShareLogEntry'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ShareLogEntry'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.ShareActivityResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.ShareLogEntry);
  }
}(this, function(ApiClient, ShareLogEntry) {
  'use strict';
  ...
  /**
   * The ShareActivityResponse model module.
   * @module model/ShareActivityResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>ShareActivityResponse</code>.
   * @alias module:model/ShareActivityResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ShareActivityResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ShareActivityResponse} obj Optional instance to populate.
   * @return {module:model/ShareActivityResponse} The populated <code>ShareActivityResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [ShareLogEntry]);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/ShareActivityResponse.SuccessEnum} success
   */
   ...
   * @member {Array.<module:model/ShareLogEntry>} results
   */
