...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LogEntry'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LogEntry'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.LogResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.LogEntry);
  }
}(this, function(ApiClient, LogEntry) {
  'use strict';
   ...
   * @member {module:model/LogResponse.SuccessEnum} success
   */
