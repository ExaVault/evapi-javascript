...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.MoveResources = factory(root.ExaVaultApi.ApiClient);
  }
  ...
  /**
   * The MoveResources model module.
   * @module model/MoveResources
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>MoveResources</code>.
   * @alias module:model/MoveResources
   * @class
   * @param accessToken {String} Access token required to make the API call.
   * @param filePaths {Array.<String>} Array containing file/folder paths to move.
   * @param destinationPath {String} Remote destination path to move files/folders to.
   */
  var exports = function(accessToken, filePaths, destinationPath) {
    var _this = this;
  ...
  /**
   * Constructs a <code>MoveResources</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MoveResources} obj Optional instance to populate.
   * @return {module:model/MoveResources} The populated <code>MoveResources</code> instance.
   */
