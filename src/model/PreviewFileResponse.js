...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PreviewFile'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PreviewFile'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.PreviewFileResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.PreviewFile);
  }
}(this, function(ApiClient, PreviewFile) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = PreviewFile.constructFromObject(data['results']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/PreviewFileResponse.SuccessEnum} success
   */
   ...
   * @member {module:model/PreviewFile} results
   */
