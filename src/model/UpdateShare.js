...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.UpdateShare = factory(root.ExaVaultApi.ApiClient);
  }
  ...
  /**
   * The UpdateShare model module.
   * @module model/UpdateShare
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>UpdateShare</code>.
   * @alias module:model/UpdateShare
   * @class
   * @param accessToken {String} Access token required to make the API call.
   * @param id {Number} ID of the share to update. Use <a href=\"#operation/getShares\">getShares</a> if you need to lookup an ID.
   */
  ...
  /**
   * Constructs a <code>UpdateShare</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateShare} obj Optional instance to populate.
   * @return {module:model/UpdateShare} The populated <code>UpdateShare</code> instance.
   */
   ...
   * @member {module:model/UpdateShare.AccessModeEnum} accessMode
   */
