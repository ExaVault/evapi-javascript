...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.ExistingResource = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.ResourceProperty);
  }
  ...
  /**
   * The ExistingResource model module.
   * @module model/ExistingResource
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>ExistingResource</code>.
   * @alias module:model/ExistingResource
   * @class
   */
  ...
  /**
   * Constructs a <code>ExistingResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExistingResource} obj Optional instance to populate.
   * @return {module:model/ExistingResource} The populated <code>ExistingResource</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('resource')) {
        obj['resource'] = ResourceProperty.constructFromObject(data['resource']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ResourceProperty} resource
   */
