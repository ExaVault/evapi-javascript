...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.CreateUser = factory(root.ExaVaultApi.ApiClient);
  }
   ...
   * @param username {String} Username of the user to create. This should follow standard username conventions; e.g. all lowercase, no spaces, etc. We do allow email addresses as usernames.
   * @param destinationFolder {String} The path to the user's home folder. For the account root, specify `/`. Otherwise, use standard Unix path format, e.g. `/path/to/some/dir`. The user will be locked to this directory and unable to move 'up' in the account.
   * @param email {String} The user's email address.
   * @param password {String} The user's password.
   * @param role {module:model/CreateUser.RoleEnum} The user's role. Note that admin users cannot have a `destinationFolder` other than `/`, and will be setup with full permissions regardless of what you specify in the `permissions` property.
   * @param permissions {module:model/CreateUser.PermissionsEnum} A CSV string of user permissions. For example: `upload,download,list`. Note that users will be unable to see any files in the account unless you include `list` permission.  
   * @param timeZone {String} The user's timezone, used for accurate time display within the application. See <a href='https://php.net/manual/en/timezones.php' target='blank'>this page</a> for allowed values. 
   */
  var exports = function(accessToken, username, destinationFolder, email, password, role, permissions, timeZone) {
    var _this = this;

    _this['access_token'] = accessToken;
    _this['username'] = username;

    _this['destinationFolder'] = destinationFolder;
    _this['email'] = email;
   ...
   */
  exports.prototype['destinationFolder'] = undefined;
  /**
   ...
   * @member {module:model/CreateUser.RoleEnum} role
   */
   ...
   * @member {module:model/CreateUser.PermissionsEnum} permissions
   */
   ...
   * @default false
   */
  exports.prototype['welcomeEmail'] = false;
