...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.AccountResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.Account);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = Account.constructFromObject(data['results']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/AccountResponse.SuccessEnum} success
   */
  ...
  /**
   * @member {module:model/Account} results
   */
