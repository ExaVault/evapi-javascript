...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.CreateNotification = factory(root.ExaVaultApi.ApiClient);
  }
  ...
  /**
   * The CreateNotification model module.
   * @module model/CreateNotification
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>CreateNotification</code>.
   * @alias module:model/CreateNotification
   * @class
   * @param accessToken {String} Access token required to make the API call.
   * @param type {module:model/CreateNotification.TypeEnum} Type of resource you're setting the notification on.
   * @param path {String} Full path of file/folder where the notification is set.
   * @param action {module:model/CreateNotification.ActionEnum} Type of action to filter on. Notifications will only be fired for the given type of action.
   * @param usernames {Array.<String>} Determines which users should trigger the notification. Either one of the values above, or an array of usernames.
   * @param sendEmail {Boolean} Set to true if the user should be notified by email when the notification is triggered.
   */
  var exports = function(accessToken, type, path, action, usernames, sendEmail) {
    var _this = this;
  ...
  /**
   * Constructs a <code>CreateNotification</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateNotification} obj Optional instance to populate.
   * @return {module:model/CreateNotification} The populated <code>CreateNotification</code> instance.
   */
   ...
   * @member {module:model/CreateNotification.TypeEnum} type
   */
   ...
   * @member {module:model/CreateNotification.ActionEnum} action
   */
