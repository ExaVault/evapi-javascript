...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.DeletedResource = factory(root.ExaVaultApi.ApiClient);
  }
  ...
  /**
   * The DeletedResource model module.
   * @module model/DeletedResource
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>DeletedResource</code>.
   * Array of deleted resources.
   * @alias module:model/DeletedResource
   * @class
   */
  ...
  /**
   * Constructs a <code>DeletedResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeletedResource} obj Optional instance to populate.
   * @return {module:model/DeletedResource} The populated <code>DeletedResource</code> instance.
   */
   ...
   * @member {module:model/DeletedResource.SuccessEnum} success
   */
