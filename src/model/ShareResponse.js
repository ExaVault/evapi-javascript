...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ExaVaultApi.ShareResponse = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.Share);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = Share.constructFromObject(data['results']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/ShareResponse.SuccessEnum} success
   */
   ...
   * @member {module:model/Share} results
   */
