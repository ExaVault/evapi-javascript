...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AuthResponse', 'model/Response'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AuthResponse'), require('../model/Response'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.AuthenticationApi = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.AuthResponse, root.ExaVaultApi.Response);
  }
}(this, function(ApiClient, AuthResponse, Response) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.authenticateUser = function(apiKey, username, password, callback) {
      var postBody = null;
      ...
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling authenticateUser");
      }

      // verify the required parameter 'password' is set
      if (password === undefined || password === null) {
        throw new Error("Missing the required parameter 'password' when calling authenticateUser");
      }
     ...
     */
    this.logoutUser = function(apiKey, accessToken, callback) {
      var postBody = null;
      ...
      if (accessToken === undefined || accessToken === null) {
        throw new Error("Missing the required parameter 'accessToken' when calling logoutUser");
      }
