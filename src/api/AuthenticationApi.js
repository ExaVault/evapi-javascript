...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AuthResponse', 'model/AuthenticateUser', 'model/LogoutUser', 'model/Response'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AuthResponse'), require('../model/AuthenticateUser'), require('../model/LogoutUser'), require('../model/Response'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.AuthenticationApi = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.AuthResponse, root.ExaVaultApi.AuthenticateUser, root.ExaVaultApi.LogoutUser, root.ExaVaultApi.Response);
  }
}(this, function(ApiClient, AuthResponse, AuthenticateUser, LogoutUser, Response) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/AuthenticationApi~authenticateUserCallback
     ...
     * @param {module:model/AuthenticateUser} opts.authenticateUser 
     * @param {module:api/AuthenticationApi~authenticateUserCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AuthResponse}
     */
    this.authenticateUser = function(apiKey, opts, callback) {
      opts = opts || {};
      var postBody = {};

      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling authenticateUser");
      }
     ...
     * @param {String} apiKey API key required to make the API call.
     * @param {Object} opts Optional parameters
     * @param {module:model/LogoutUser} opts.logoutUser 
     ...
     */
    this.logoutUser = function(apiKey, opts, callback) {
      opts = opts || {};
      var postBody = {};

      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling logoutUser");
      }
