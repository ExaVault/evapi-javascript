...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateNotification', 'model/NotificationResponse', 'model/NotificationsResponse', 'model/Response', 'model/UpdateNotification'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateNotification'), require('../model/NotificationResponse'), require('../model/NotificationsResponse'), require('../model/Response'), require('../model/UpdateNotification'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.NotificationApi = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.CreateNotification, root.ExaVaultApi.NotificationResponse, root.ExaVaultApi.NotificationsResponse, root.ExaVaultApi.Response, root.ExaVaultApi.UpdateNotification);
  }
}(this, function(ApiClient, CreateNotification, NotificationResponse, NotificationsResponse, Response, UpdateNotification) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/CreateNotification} opts.createNotification 
     ...
     */
    this.createNotification = function(apiKey, opts, callback) {
      opts = opts || {};
      var postBody = {};
