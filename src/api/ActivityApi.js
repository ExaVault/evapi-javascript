...
var ActivityApi = function () {
  ...
  */
  ...
  _createClass(ActivityApi, [{
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/WebhooksActivityResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/WebhooksActivityResponse}
     */
    ...
    value: function getWebhookLogs(evApiKey, evAccessToken, opts, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _WebhooksActivityResponse2.default;
