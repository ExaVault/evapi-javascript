...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DeletedResourcesResponse', 'model/ExistingResourcesResponse', 'model/ModifiedResourcesResponse', 'model/PreviewFileResponse', 'model/ResourcePropertiesResponse', 'model/ResourceResponse', 'model/Response', 'model/UrlResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DeletedResourcesResponse'), require('../model/ExistingResourcesResponse'), require('../model/ModifiedResourcesResponse'), require('../model/PreviewFileResponse'), require('../model/ResourcePropertiesResponse'), require('../model/ResourceResponse'), require('../model/Response'), require('../model/UrlResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.ExaVaultApi) {
      root.ExaVaultApi = {};
    }
    root.ExaVaultApi.FilesAndFoldersApi = factory(root.ExaVaultApi.ApiClient, root.ExaVaultApi.DeletedResourcesResponse, root.ExaVaultApi.ExistingResourcesResponse, root.ExaVaultApi.ModifiedResourcesResponse, root.ExaVaultApi.PreviewFileResponse, root.ExaVaultApi.ResourcePropertiesResponse, root.ExaVaultApi.ResourceResponse, root.ExaVaultApi.Response, root.ExaVaultApi.UrlResponse);
  }
}(this, function(ApiClient, DeletedResourcesResponse, ExistingResourcesResponse, ModifiedResourcesResponse, PreviewFileResponse, ResourcePropertiesResponse, ResourceResponse, Response, UrlResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} apiKey API key required to make the API call.
     * @param {String} accessToken Access token required to make the API call.
     * @param {Array.<String>} filePaths Array containing file/folder paths to copy.
     * @param {String} destinationPath Remote destination path to copy files/folders to.
     ...
     */
    this.copyResources = function(apiKey, accessToken, filePaths, destinationPath, callback) {
      var postBody = null;
      ...
      // verify the required parameter 'accessToken' is set
      if (accessToken === undefined || accessToken === null) {
        throw new Error("Missing the required parameter 'accessToken' when calling copyResources");
      }

      // verify the required parameter 'filePaths' is set
      if (filePaths === undefined || filePaths === null) {
        throw new Error("Missing the required parameter 'filePaths' when calling copyResources");
      }

      // verify the required parameter 'destinationPath' is set
      if (destinationPath === undefined || destinationPath === null) {
        throw new Error("Missing the required parameter 'destinationPath' when calling copyResources");
      }
      ...
      var formParams = {
        'access_token': accessToken,
        //EV add [] to the filePath key name to make correct call
        'filePaths[]': this.apiClient.buildCollectionParam(filePaths, 'multi'),
     ...
     * @param {String} path Where to create the folder. Use **_/_** to create a folder in the user&#39;s home directory.
     ...
     */
    this.createFolder = function(apiKey, accessToken, folderName, path, callback) {
      var postBody = null;
      ...
      // verify the required parameter 'accessToken' is set
      if (accessToken === undefined || accessToken === null) {
        throw new Error("Missing the required parameter 'accessToken' when calling createFolder");
      }

      // verify the required parameter 'folderName' is set
      if (folderName === undefined || folderName === null) {
        throw new Error("Missing the required parameter 'folderName' when calling createFolder");
      }
     ...
     * @param {String} apiKey API key required to make the API call.
     * @param {String} accessToken Access token required to make the API call.
     * @param {Array.<String>} filePaths Array containing file/folder paths to move.
     * @param {String} destinationPath Remote destination path to move files/folders to.
     ...
     * data is of type: {@link module:model/ModifiedResourcesResponse}
     */
    this.moveResources = function(apiKey, accessToken, filePaths, destinationPath, callback) {
      var postBody = null;
      ...
      // verify the required parameter 'accessToken' is set
      if (accessToken === undefined || accessToken === null) {
        throw new Error("Missing the required parameter 'accessToken' when calling moveResources");
      }

      // verify the required parameter 'filePaths' is set
      if (filePaths === undefined || filePaths === null) {
        throw new Error("Missing the required parameter 'filePaths' when calling moveResources");
      }

      // verify the required parameter 'destinationPath' is set
      if (destinationPath === undefined || destinationPath === null) {
        throw new Error("Missing the required parameter 'destinationPath' when calling moveResources");
      }
     ...
     * @param {String} apiKey API key required to make the API call.
     * @param {String} accessToken Access token required to make the API call.
     * @param {String} filePath Remote path of the file or folder to rename.
     ...
     * data is of type: {@link module:model/Response}
     */
    this.renameResource = function(apiKey, accessToken, filePath, newName, callback) {
      var postBody = null;
      ...
      // verify the required parameter 'accessToken' is set
      if (accessToken === undefined || accessToken === null) {
        throw new Error("Missing the required parameter 'accessToken' when calling renameResource");
      }

      // verify the required parameter 'filePath' is set
      if (filePath === undefined || filePath === null) {
        throw new Error("Missing the required parameter 'filePath' when calling renameResource");
      }

      // verify the required parameter 'newName' is set
      if (newName === undefined || newName === null) {
        throw new Error("Missing the required parameter 'newName' when calling renameResource");
      }
