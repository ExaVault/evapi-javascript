...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.ShareApi();
  });
  ...
  describe('ShareApi', function() {
    describe('createShare', function() {
      it('should call createShare successfully', function(done) {
        //uncomment below and update the code to test createShare
        //instance.createShare(function(error) {
    ...
    describe('getShare', function() {
      it('should call getShare successfully', function(done) {
        //uncomment below and update the code to test getShare
        //instance.getShare(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
