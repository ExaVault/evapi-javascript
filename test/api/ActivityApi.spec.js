...
(function (root, factory) {
  ...
  describe('ActivityApi', function () {
    describe('getSessionLogs', function () {
      it('should call getSessionLogs successfully', function (done) {
        //uncomment below and update the code to test getSessionLogs
        //instance.getSessionLogs(function(error) {
