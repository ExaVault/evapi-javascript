...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.ActivityApi();
  });
  ...
  describe('ActivityApi', function() {
    describe('getFileActivityLogs', function() {
      it('should call getFileActivityLogs successfully', function(done) {
        //uncomment below and update the code to test getFileActivityLogs
        //instance.getFileActivityLogs(function(error) {
    ...
    describe('getNotificationActivity', function() {
      it('should call getNotificationActivity successfully', function(done) {
        //uncomment below and update the code to test getNotificationActivity
        //instance.getNotificationActivity(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getShareActivity', function() {
      it('should call getShareActivity successfully', function(done) {
        //uncomment below and update the code to test getShareActivity
        //instance.getShareActivity(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
