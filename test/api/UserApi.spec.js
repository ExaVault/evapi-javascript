...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.UserApi();
  });
  ...
  describe('UserApi', function() {
    ...
    describe('userAvailable', function() {
      it('should call userAvailable successfully', function(done) {
        //uncomment below and update the code to test userAvailable
        //instance.userAvailable(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
