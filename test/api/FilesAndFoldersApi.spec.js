...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.FilesAndFoldersApi();
  });
  ...
  describe('FilesAndFoldersApi', function() {
    describe('checkFilesExist', function() {
      it('should call checkFilesExist successfully', function(done) {
        //uncomment below and update the code to test checkFilesExist
        //instance.checkFilesExist(function(error) {
    ...
    describe('getDownloadFileUrl', function() {
      it('should call getDownloadFileUrl successfully', function(done) {
        //uncomment below and update the code to test getDownloadFileUrl
        //instance.getDownloadFileUrl(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getResourceList', function() {
      it('should call getResourceList successfully', function(done) {
        //uncomment below and update the code to test getResourceList
        //instance.getResourceList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getResourceProperties', function() {
      it('should call getResourceProperties successfully', function(done) {
        //uncomment below and update the code to test getResourceProperties
        //instance.getResourceProperties(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getUploadFileUrl', function() {
      it('should call getUploadFileUrl successfully', function(done) {
        //uncomment below and update the code to test getUploadFileUrl
        //instance.getUploadFileUrl(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('previewFile', function() {
      it('should call previewFile successfully', function(done) {
        //uncomment below and update the code to test previewFile
        //instance.previewFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('renameResource', function() {
      it('should call renameResource successfully', function(done) {
        //uncomment below and update the code to test renameResource
        //instance.renameResource(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
