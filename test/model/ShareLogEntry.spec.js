...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.ShareLogEntry();
  });
  ...
  describe('ShareLogEntry', function() {
    it('should create an instance of ShareLogEntry', function() {
      // uncomment below and update the code to test ShareLogEntry
      //var instane = new ExaVaultApi.ShareLogEntry();
      //expect(instance).to.be.a(ExaVaultApi.ShareLogEntry);
    });
    ...
    it('should have the property actionObjectId (base name: "actionObjectId")', function() {
      // uncomment below and update the code to test the property actionObjectId
      //var instane = new ExaVaultApi.ShareLogEntry();
      //expect(instance).to.be();
    });
