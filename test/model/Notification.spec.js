...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.Notification();
  });
  ...
  describe('Notification', function() {
    it('should create an instance of Notification', function() {
      ...
      //var instane = new ExaVaultApi.Notification();
      //expect(instance).to.be.a(ExaVaultApi.Notification);
    });
    ...
    it('should have the property recipientEmails (base name: "recipientEmails")', function() {
      // uncomment below and update the code to test the property recipientEmails
      //var instane = new ExaVaultApi.Notification();
      //expect(instance).to.be();
    });
