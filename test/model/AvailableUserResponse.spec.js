...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.AvailableUserResponse();
  });
  ...
  describe('AvailableUserResponse', function() {
    it('should create an instance of AvailableUserResponse', function() {
      // uncomment below and update the code to test AvailableUserResponse
      //var instane = new ExaVaultApi.AvailableUserResponse();
      //expect(instance).to.be.a(ExaVaultApi.AvailableUserResponse);
    });
