...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.AuthenticateUser();
  });
  ...
  describe('AuthenticateUser', function() {
    it('should create an instance of AuthenticateUser', function() {
      // uncomment below and update the code to test AuthenticateUser
      //var instane = new ExaVaultApi.AuthenticateUser();
      //expect(instance).to.be.a(ExaVaultApi.AuthenticateUser);
    });
