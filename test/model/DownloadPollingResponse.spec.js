...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.DownloadPollingResponse();
  });
  ...
  describe('DownloadPollingResponse', function () {
    it('should create an instance of DownloadPollingResponse', function () {
      // uncomment below and update the code to test DownloadPollingResponse
      //var instane = new ExaVaultApi.DownloadPollingResponse();
      //expect(instance).to.be.a(ExaVaultApi.DownloadPollingResponse);
    });
