...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.ShareActivityResponse();
  });
  ...
  describe('ShareActivityResponse', function() {
    it('should create an instance of ShareActivityResponse', function() {
      // uncomment below and update the code to test ShareActivityResponse
      //var instane = new ExaVaultApi.ShareActivityResponse();
      //expect(instance).to.be.a(ExaVaultApi.ShareActivityResponse);
    });
