...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.AvailableUser();
  });
  ...
  describe('AvailableUser', function() {
    it('should create an instance of AvailableUser', function() {
      // uncomment below and update the code to test AvailableUser
      //var instane = new ExaVaultApi.AvailableUser();
      //expect(instance).to.be.a(ExaVaultApi.AvailableUser);
    });
