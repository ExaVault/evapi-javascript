...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.NotificationMessage();
  });
  ...
  describe('NotificationMessage', function() {
    it('should create an instance of NotificationMessage', function() {
      ...
      //var instane = new ExaVaultApi.NotificationMessage();
      //expect(instance).to.be.a(ExaVaultApi.NotificationMessage);
    });
    ...
    it('should have the property notificationSetting (base name: "notificationSetting")', function() {
      // uncomment below and update the code to test the property notificationSetting
      //var instane = new ExaVaultApi.NotificationMessage();
      //expect(instance).to.be();
    });
