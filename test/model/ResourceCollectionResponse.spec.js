...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.ResourceCollectionResponse();
  });
  ...
  describe('ResourceCollectionResponse', function () {
    it('should create an instance of ResourceCollectionResponse', function () {
      // uncomment below and update the code to test ResourceCollectionResponse
      //var instane = new ExaVaultApi.ResourceCollectionResponse();
      //expect(instance).to.be.a(ExaVaultApi.ResourceCollectionResponse);
    });
