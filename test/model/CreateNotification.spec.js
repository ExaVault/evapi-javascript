...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.CreateNotification();
  });
  ...
  describe('CreateNotification', function() {
    it('should create an instance of CreateNotification', function() {
      // uncomment below and update the code to test CreateNotification
      //var instane = new ExaVaultApi.CreateNotification();
      //expect(instance).to.be.a(ExaVaultApi.CreateNotification);
    });
