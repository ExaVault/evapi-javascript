...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.EmailListCollectionResponse();
  });
  ...
  describe('EmailListCollectionResponse', function () {
    it('should create an instance of EmailListCollectionResponse', function () {
      // uncomment below and update the code to test EmailListCollectionResponse
      //var instane = new ExaVaultApi.EmailListCollectionResponse();
      //expect(instance).to.be.a(ExaVaultApi.EmailListCollectionResponse);
    });
