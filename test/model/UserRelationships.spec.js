...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.UserRelationships();
  });
  ...
  describe('UserRelationships', function () {
    it('should create an instance of UserRelationships', function () {
      // uncomment below and update the code to test UserRelationships
      //var instane = new ExaVaultApi.UserRelationships();
      //expect(instance).to.be.a(ExaVaultApi.UserRelationships);
    });
