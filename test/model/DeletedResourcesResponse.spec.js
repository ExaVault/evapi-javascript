...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.DeletedResourcesResponse();
  });
  ...
  describe('DeletedResourcesResponse', function() {
    it('should create an instance of DeletedResourcesResponse', function() {
      // uncomment below and update the code to test DeletedResourcesResponse
      //var instane = new ExaVaultApi.DeletedResourcesResponse();
      //expect(instance).to.be.a(ExaVaultApi.DeletedResourcesResponse);
    });
