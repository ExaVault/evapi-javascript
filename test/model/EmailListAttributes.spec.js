...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.EmailListAttributes();
  });
  ...
  describe('EmailListAttributes', function () {
    it('should create an instance of EmailListAttributes', function () {
      // uncomment below and update the code to test EmailListAttributes
      //var instane = new ExaVaultApi.EmailListAttributes();
      //expect(instance).to.be.a(ExaVaultApi.EmailListAttributes);
    });
