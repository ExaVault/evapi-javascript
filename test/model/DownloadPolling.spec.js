...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.DownloadPolling();
  });
  ...
  describe('DownloadPolling', function () {
    it('should create an instance of DownloadPolling', function () {
      // uncomment below and update the code to test DownloadPolling
      //var instane = new ExaVaultApi.DownloadPolling();
      //expect(instance).to.be.a(ExaVaultApi.DownloadPolling);
    });
