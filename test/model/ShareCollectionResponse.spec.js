...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.ShareCollectionResponse();
  });
  ...
  describe('ShareCollectionResponse', function () {
    it('should create an instance of ShareCollectionResponse', function () {
      ...
      //var instane = new ExaVaultApi.ShareCollectionResponse();
      //expect(instance).to.be.a(ExaVaultApi.ShareCollectionResponse);
    });
