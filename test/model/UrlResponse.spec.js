...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.UrlResponse();
  });
  ...
  describe('UrlResponse', function() {
    it('should create an instance of UrlResponse', function() {
      // uncomment below and update the code to test UrlResponse
      //var instane = new ExaVaultApi.UrlResponse();
      //expect(instance).to.be.a(ExaVaultApi.UrlResponse);
    });
