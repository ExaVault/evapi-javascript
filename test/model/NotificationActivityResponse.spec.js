...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.NotificationActivityResponse();
  });
  ...
  describe('NotificationActivityResponse', function() {
    it('should create an instance of NotificationActivityResponse', function() {
      // uncomment below and update the code to test NotificationActivityResponse
      //var instane = new ExaVaultApi.NotificationActivityResponse();
      //expect(instance).to.be.a(ExaVaultApi.NotificationActivityResponse);
    });
