...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.UserCollectionResponse();
  });
  ...
  describe('UserCollectionResponse', function () {
    it('should create an instance of UserCollectionResponse', function () {
      // uncomment below and update the code to test UserCollectionResponse
      //var instane = new ExaVaultApi.UserCollectionResponse();
      //expect(instance).to.be.a(ExaVaultApi.UserCollectionResponse);
    });
