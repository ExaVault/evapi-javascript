...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.AccountAllowedIpRanges();
  });
  ...
  describe('AccountAllowedIpRanges', function () {
    it('should create an instance of AccountAllowedIpRanges', function () {
      // uncomment below and update the code to test AccountAllowedIpRanges
      //var instane = new ExaVaultApi.AccountAllowedIpRanges();
      //expect(instance).to.be.a(ExaVaultApi.AccountAllowedIpRanges);
    });
