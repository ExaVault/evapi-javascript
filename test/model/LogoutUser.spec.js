...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.LogoutUser();
  });
  ...
  describe('LogoutUser', function() {
    it('should create an instance of LogoutUser', function() {
      // uncomment below and update the code to test LogoutUser
      //var instane = new ExaVaultApi.LogoutUser();
      //expect(instance).to.be.a(ExaVaultApi.LogoutUser);
    });
