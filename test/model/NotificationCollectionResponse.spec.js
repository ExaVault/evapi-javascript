...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.NotificationCollectionResponse();
  });
  ...
  describe('NotificationCollectionResponse', function () {
    it('should create an instance of NotificationCollectionResponse', function () {
      // uncomment below and update the code to test NotificationCollectionResponse
      //var instane = new ExaVaultApi.NotificationCollectionResponse();
      //expect(instance).to.be.a(ExaVaultApi.NotificationCollectionResponse);
    });
