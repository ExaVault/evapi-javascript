...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.Error401();
  });
  ...
  describe('Error401', function () {
    it('should create an instance of Error401', function () {
      // uncomment below and update the code to test Error401
      //var instane = new ExaVaultApi.Error401();
      //expect(instance).to.be.a(ExaVaultApi.Error401);
    });
