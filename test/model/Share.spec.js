...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.Share();
  });
  ...
  describe('Share', function() {
    it('should create an instance of Share', function() {
      ...
      //var instane = new ExaVaultApi.Share();
      //expect(instance).to.be.a(ExaVaultApi.Share);
    });
    ...
    it('should have the property ownerUsername (base name: "ownerUsername")', function() {
    ...
    it('should have the property recipientsWithOwner (base name: "recipientsWithOwner")', function() {
      // uncomment below and update the code to test the property recipientsWithOwner
      //var instane = new ExaVaultApi.Share();
      //expect(instance).to.be();
    });
