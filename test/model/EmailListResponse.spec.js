...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.EmailListResponse();
  });
  ...
  describe('EmailListResponse', function () {
    it('should create an instance of EmailListResponse', function () {
      // uncomment below and update the code to test EmailListResponse
      //var instane = new ExaVaultApi.EmailListResponse();
      //expect(instance).to.be.a(ExaVaultApi.EmailListResponse);
    });
