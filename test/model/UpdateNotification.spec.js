...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.UpdateNotification();
  });
  ...
  describe('UpdateNotification', function() {
    it('should create an instance of UpdateNotification', function() {
      // uncomment below and update the code to test UpdateNotification
      //var instane = new ExaVaultApi.UpdateNotification();
      //expect(instance).to.be.a(ExaVaultApi.UpdateNotification);
    });
