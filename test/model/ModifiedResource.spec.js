...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.ModifiedResource();
  });
  ...
  describe('ModifiedResource', function() {
    it('should create an instance of ModifiedResource', function() {
      // uncomment below and update the code to test ModifiedResource
      //var instane = new ExaVaultApi.ModifiedResource();
      //expect(instance).to.be.a(ExaVaultApi.ModifiedResource);
    });
