...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.UpdateShare();
  });
  ...
  describe('UpdateShare', function() {
    it('should create an instance of UpdateShare', function() {
      // uncomment below and update the code to test UpdateShare
      //var instane = new ExaVaultApi.UpdateShare();
      //expect(instance).to.be.a(ExaVaultApi.UpdateShare);
    });
