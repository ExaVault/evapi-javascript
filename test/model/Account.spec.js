...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instane = new ExaVaultApi.Account();
      //expect(instance).to.be.a(ExaVaultApi.Account);
    });
    ...
    it('should have the property masterAccount (base name: "masterAccount")', function() {
      // uncomment below and update the code to test the property masterAccount
      //var instane = new ExaVaultApi.Account();
      //expect(instance).to.be();
    });
    ...
    it('should have the property planCode (base name: "planCode")', function() {
    ...
    it('should have the property diskQuotaLimit (base name: "diskQuotaLimit")', function() {
      // uncomment below and update the code to test the property diskQuotaLimit
      //var instane = new ExaVaultApi.Account();
      //expect(instance).to.be();
    });

    it('should have the property bandwidthQuotaLimit (base name: "bandwidthQuotaLimit")', function() {
      // uncomment below and update the code to test the property bandwidthQuotaLimit
      //var instane = new ExaVaultApi.Account();
      //expect(instance).to.be();
    });

    it('should have the property diskQuotaUsed (base name: "diskQuotaUsed")', function() {
      // uncomment below and update the code to test the property diskQuotaUsed
      //var instane = new ExaVaultApi.Account();
      //expect(instance).to.be();
    });

    it('should have the property bandwidthQuotaUsed (base name: "bandwidthQuotaUsed")', function() {
      // uncomment below and update the code to test the property bandwidthQuotaUsed
      //var instane = new ExaVaultApi.Account();
      //expect(instance).to.be();
    });
    ...
    it('should have the property appliedTrial (base name: "appliedTrial")', function() {
      // uncomment below and update the code to test the property appliedTrial
      //var instane = new ExaVaultApi.Account();
      //expect(instance).to.be();
    });
