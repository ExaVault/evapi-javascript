...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.SessionActivityResponse();
  });
  ...
  describe('SessionActivityResponse', function () {
    it('should create an instance of SessionActivityResponse', function () {
      // uncomment below and update the code to test SessionActivityResponse
      //var instane = new ExaVaultApi.SessionActivityResponse();
      //expect(instance).to.be.a(ExaVaultApi.SessionActivityResponse);
    });
