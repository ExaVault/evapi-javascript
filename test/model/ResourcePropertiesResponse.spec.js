...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.ResourcePropertiesResponse();
  });
  ...
  describe('ResourcePropertiesResponse', function() {
    it('should create an instance of ResourcePropertiesResponse', function() {
      // uncomment below and update the code to test ResourcePropertiesResponse
      //var instane = new ExaVaultApi.ResourcePropertiesResponse();
      //expect(instance).to.be.a(ExaVaultApi.ResourcePropertiesResponse);
    });
