...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.NotificationsResponse();
  });
  ...
  describe('NotificationsResponse', function() {
    it('should create an instance of NotificationsResponse', function() {
      ...
      //var instane = new ExaVaultApi.NotificationsResponse();
      //expect(instance).to.be.a(ExaVaultApi.NotificationsResponse);
    });
