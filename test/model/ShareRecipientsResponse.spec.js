...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.ShareRecipientsResponse();
  });
  ...
  describe('ShareRecipientsResponse', function () {
    it('should create an instance of ShareRecipientsResponse', function () {
      // uncomment below and update the code to test ShareRecipientsResponse
      //var instane = new ExaVaultApi.ShareRecipientsResponse();
      //expect(instance).to.be.a(ExaVaultApi.ShareRecipientsResponse);
    });
