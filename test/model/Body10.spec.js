...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.Body10();
  });
  ...
  describe('Body10', function () {
    it('should create an instance of Body10', function () {
      ...
      //var instane = new ExaVaultApi.Body10();
      //expect(instance).to.be.a(ExaVaultApi.Body10);
    });
    ...
    it('should have the property archiveName (base name: "archive Name")', function () {
