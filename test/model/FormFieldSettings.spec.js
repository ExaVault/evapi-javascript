...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.FormFieldSettings();
  });
  ...
  describe('FormFieldSettings', function () {
    it('should create an instance of FormFieldSettings', function () {
      // uncomment below and update the code to test FormFieldSettings
      //var instane = new ExaVaultApi.FormFieldSettings();
      //expect(instance).to.be.a(ExaVaultApi.FormFieldSettings);
    });
