...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.NotificationRecipient();
  });
  ...
  describe('NotificationRecipient', function() {
    it('should create an instance of NotificationRecipient', function() {
      // uncomment below and update the code to test NotificationRecipient
      //var instane = new ExaVaultApi.NotificationRecipient();
      //expect(instance).to.be.a(ExaVaultApi.NotificationRecipient);
    });
