...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.ShareRecipient1();
  });
  ...
  describe('ShareRecipient1', function () {
    it('should create an instance of ShareRecipient1', function () {
      // uncomment below and update the code to test ShareRecipient1
      //var instane = new ExaVaultApi.ShareRecipient1();
      //expect(instance).to.be.a(ExaVaultApi.ShareRecipient1);
    });
