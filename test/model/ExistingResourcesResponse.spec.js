...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.ExistingResourcesResponse();
  });
  ...
  describe('ExistingResourcesResponse', function() {
    it('should create an instance of ExistingResourcesResponse', function() {
      // uncomment below and update the code to test ExistingResourcesResponse
      //var instane = new ExaVaultApi.ExistingResourcesResponse();
      //expect(instance).to.be.a(ExaVaultApi.ExistingResourcesResponse);
    });
