...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.ExistingResource();
  });
  ...
  describe('ExistingResource', function() {
    it('should create an instance of ExistingResource', function() {
      // uncomment below and update the code to test ExistingResource
      //var instane = new ExaVaultApi.ExistingResource();
      //expect(instance).to.be.a(ExaVaultApi.ExistingResource);
    });
