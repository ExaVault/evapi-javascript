...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.MasterUser();
  });
  ...
  describe('MasterUser', function () {
    it('should create an instance of MasterUser', function () {
      // uncomment below and update the code to test MasterUser
      //var instane = new ExaVaultApi.MasterUser();
      //expect(instance).to.be.a(ExaVaultApi.MasterUser);
    });
