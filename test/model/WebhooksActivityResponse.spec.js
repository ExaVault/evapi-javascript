...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.WebhooksActivityResponse();
  });
  ...
  describe('WebhooksActivityResponse', function () {
    it('should create an instance of WebhooksActivityResponse', function () {
      // uncomment below and update the code to test WebhooksActivityResponse
      //var instane = new ExaVaultApi.WebhooksActivityResponse();
      //expect(instance).to.be.a(ExaVaultApi.WebhooksActivityResponse);
    });
