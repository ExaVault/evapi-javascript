...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.Error403Errors();
  });
  ...
  describe('Error403Errors', function () {
    it('should create an instance of Error403Errors', function () {
      // uncomment below and update the code to test Error403Errors
      //var instane = new ExaVaultApi.Error403Errors();
      //expect(instance).to.be.a(ExaVaultApi.Error403Errors);
    });
