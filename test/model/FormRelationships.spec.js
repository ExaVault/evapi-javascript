...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.FormRelationships();
  });
  ...
  describe('FormRelationships', function () {
    it('should create an instance of FormRelationships', function () {
      // uncomment below and update the code to test FormRelationships
      //var instane = new ExaVaultApi.FormRelationships();
      //expect(instance).to.be.a(ExaVaultApi.FormRelationships);
    });
