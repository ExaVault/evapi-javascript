...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.SharesResponse();
  });
  ...
  describe('SharesResponse', function() {
    it('should create an instance of SharesResponse', function() {
      // uncomment below and update the code to test SharesResponse
      //var instane = new ExaVaultApi.SharesResponse();
      //expect(instance).to.be.a(ExaVaultApi.SharesResponse);
    });
