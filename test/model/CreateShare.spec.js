...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.CreateShare();
  });
  ...
  describe('CreateShare', function() {
    it('should create an instance of CreateShare', function() {
      // uncomment below and update the code to test CreateShare
      //var instane = new ExaVaultApi.CreateShare();
      //expect(instance).to.be.a(ExaVaultApi.CreateShare);
    });
