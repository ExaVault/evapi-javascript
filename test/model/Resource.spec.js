...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instane = new ExaVaultApi.Resource();
      //expect(instance).to.be.a(ExaVaultApi.Resource);
    });
    ...
    it('should have the property inheritedShares (base name: "inheritedShares")', function() {
      // uncomment below and update the code to test the property inheritedShares
      //var instane = new ExaVaultApi.Resource();
      //expect(instance).to.be();
    });

    it('should have the property inheritedNotifications (base name: "inheritedNotifications")', function() {
      // uncomment below and update the code to test the property inheritedNotifications
      //var instane = new ExaVaultApi.Resource();
      //expect(instance).to.be();
    });

    it('should have the property inheritedDirectFiles (base name: "inheritedDirectFiles")', function() {
      // uncomment below and update the code to test the property inheritedDirectFiles
      //var instane = new ExaVaultApi.Resource();
      //expect(instance).to.be();
    });
