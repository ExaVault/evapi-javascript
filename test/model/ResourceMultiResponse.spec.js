...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.ResourceMultiResponse();
  });
  ...
  describe('ResourceMultiResponse', function () {
    it('should create an instance of ResourceMultiResponse', function () {
      // uncomment below and update the code to test ResourceMultiResponse
      //var instane = new ExaVaultApi.ResourceMultiResponse();
      //expect(instance).to.be.a(ExaVaultApi.ResourceMultiResponse);
    });
