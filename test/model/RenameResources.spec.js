...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.RenameResources();
  });
  ...
  describe('RenameResources', function() {
    it('should create an instance of RenameResources', function() {
      // uncomment below and update the code to test RenameResources
      //var instane = new ExaVaultApi.RenameResources();
      //expect(instance).to.be.a(ExaVaultApi.RenameResources);
    });
