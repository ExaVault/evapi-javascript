...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.ModifiedResourcesResponse();
  });
  ...
  describe('ModifiedResourcesResponse', function() {
    it('should create an instance of ModifiedResourcesResponse', function() {
      // uncomment below and update the code to test ModifiedResourcesResponse
      //var instane = new ExaVaultApi.ModifiedResourcesResponse();
      //expect(instance).to.be.a(ExaVaultApi.ModifiedResourcesResponse);
    });
