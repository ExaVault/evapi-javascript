...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.CopyResources();
  });
  ...
  describe('CopyResources', function() {
    it('should create an instance of CopyResources', function() {
      // uncomment below and update the code to test CopyResources
      //var instane = new ExaVaultApi.CopyResources();
      //expect(instance).to.be.a(ExaVaultApi.CopyResources);
    });
