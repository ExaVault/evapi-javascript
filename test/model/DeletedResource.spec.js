...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.DeletedResource();
  });
  ...
  describe('DeletedResource', function() {
    it('should create an instance of DeletedResource', function() {
      // uncomment below and update the code to test DeletedResource
      //var instane = new ExaVaultApi.DeletedResource();
      //expect(instance).to.be.a(ExaVaultApi.DeletedResource);
    });
