...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.Error401Errors();
  });
  ...
  describe('Error401Errors', function () {
    it('should create an instance of Error401Errors', function () {
      // uncomment below and update the code to test Error401Errors
      //var instane = new ExaVaultApi.Error401Errors();
      //expect(instance).to.be.a(ExaVaultApi.Error401Errors);
    });
