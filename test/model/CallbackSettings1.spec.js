...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new ExaVaultApi.CallbackSettings1();
  });
  ...
  describe('CallbackSettings1', function () {
    it('should create an instance of CallbackSettings1', function () {
      // uncomment below and update the code to test CallbackSettings1
      //var instane = new ExaVaultApi.CallbackSettings1();
      //expect(instance).to.be.a(ExaVaultApi.CallbackSettings1);
    });
