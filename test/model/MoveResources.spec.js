...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExaVaultApi.MoveResources();
  });
  ...
  describe('MoveResources', function() {
    it('should create an instance of MoveResources', function() {
      // uncomment below and update the code to test MoveResources
      //var instane = new ExaVaultApi.MoveResources();
      //expect(instance).to.be.a(ExaVaultApi.MoveResources);
    });
